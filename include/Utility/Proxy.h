...
/// };
///
/// class User1 : public QWidget, public Base
/// {
/// 	Q_OBJECT
/// public:
...
/// };
///
/// class User2 : public QFrame, public Base
/// {
/// 	Q_OBJECT
/// public:
/// 	QWidget* asWidget() override { return this; }
...
/// namespace UseProxy
/// {
/// struct AsWidget : Proxys::Dispatch<QWidget*()>
/// {
/// 	template<typename T>
/// 	QWidget* operator()(T& obj) const
/// 	{
/// 		return std::addressof(obj);
/// 	}
/// };
///
/// struct DoSomething : Proxys::Dispatch<void()>
/// {
/// 	template<typename T>
...
/// };
///
/// using Base = Proxys::Facade<AsWidget, DoSomething>;
///
...
/// };
///
/// void doSomething(Proxys::Proxy<Base> base)
/// {
/// 	base.invoke<DoSomething>();
/// 	base.invoke<AsWidget>()->show();
/// }
///
/// void use()
/// {
